...
$\textsc{Get}$, $\textsc{Set}$, $\textsc{Begin}$, $\textsc{End}$, or
$\textsc{Retry}$) or an \emph{administrative reduction}
(Section~\ref{subsec:semantics}).
\end{definition}
...
\bibitem[Cerone et al.(2015)]{CeroneBernardiGotsman2015}
Andrea Cerone, Giovanni Bernardi, and Alexey Gotsman. 2015.
\newblock A Framework for Transactional Consistency Models with Atomic Visibility.
\newblock In \emph{CONCUR 2015} (LIPIcs, Vol.~42). 58--71.

\bibitem[Herlihy and Wing(1990)]{HerlihyWing1990}
Maurice P. Herlihy and Jeannette M. Wing. 1990.
\newblock Linearizability: A Correctness Condition for Concurrent Objects.
\newblock \emph{ACM Trans. Program. Lang. Syst.} 12, 3 (1990), 463--492.
